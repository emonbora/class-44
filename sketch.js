...
var wall1, coin1, coin2, coin3, coin4, coin5
var wall2
var wall3
var wall4 
var wall5
...
function draw(){
 ...
 if(gameState === 0){
   ...
   // start.destroy();
    ...
    coin1 = createSprite(340, 70, 20,20);
    coin2 = createSprite(150,30,20,20)
    coin3 = createSprite(100,375,20,20)
    coin4 = createSprite(200,375,20,20)
    coin5 = createSprite(300,375,20,20)
    coin1.shapeColor = "Red"
    coin2.shapeColor = "Red"
    coin3.shapeColor = "Red"
    coin4.shapeColor = "Red"
